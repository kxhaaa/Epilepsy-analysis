...
% Last Modified by GUIDE v2.5 31-Mar-2020 09:03:57
...
caxis([-pixel, pixel])
colorbar
% x=input('Please input the name (like result):\n','s');
% save ([x,'.mat'], 'result');
% test=uint16(result.*100);
% RGB = ind2rgb(test,jet);
% imshow(RGB);
% imwrite(RGB,[x,'.tif']);
...
% prompt = 'Please set the type of signal. 0 for interictal spike, 1 for fast ripple. ';
% str = input(prompt);
...
'Position',[26.4285714285714 10.9444444444444 60.7142857142857 15.3888888888889],...
...
'Color',[0 0 0],...
'ColorMode','auto',...
'Position',[0.500000894209918 1.00992779783394 0.500000000000007],...
'PositionMode','auto',...
'Interpreter','tex',...
...
'String','Analyse two laser speckle images',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[1.28571428571429 5.11111111111111 32.1428571428571 3],...
...
'Style','text',...
'Position',[11.2857142857143 28.0555555555556 88.5714285714286 1.94444444444444],...
'Children',[],...
...
'Style','text',...
'Position',[89 -0.0555555555555556 22.8571428571429 1.05555555555556],...
'Children',[],...
'Tag','text5',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[39 5.11111111111111 32.5714285714286 3],...
...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[76.8571428571428 5.16666666666667 34.5714285714286 2.94444444444444],...
